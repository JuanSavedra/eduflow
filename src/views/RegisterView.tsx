...
export const RegisterView = () => {
  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center animate-in fade-in duration-700 px-4 py-12">
      <Card className="p-12 max-w-3xl w-full shadow-2xl border-slate-100 bg-white/80 backdrop-blur-sm">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-extrabold text-slate-900 tracking-tight">Crie sua conta EduFlow</h2>
          <p className="text-lg text-slate-500 mt-4">Junte-se a milhares de estudantes e organize sua vida acadêmica</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-7">
              ...
              <div className="space-y-3">
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-5 py-4 text-lg border rounded-xl focus:ring-4 focus:ring-indigo-500/10 outline-none transition-all ${errors.confirmPassword ? 'border-rose-500 bg-rose-50' : 'border-slate-200 focus:border-indigo-500'}`}
                    placeholder="••••••••"
                  />
          ...
          <div className="pt-6">
            <Button type="submit" className="w-full py-5 text-xl font-black shadow-xl shadow-indigo-100 hover:scale-[1.01] active:scale-[0.99] transition-all">
        ...
        <div className="mt-12 text-center border-t border-slate-100 pt-8">
          <button 
            ...
            className="text-lg font-bold text-indigo-600 hover:text-indigo-700 flex items-center justify-center gap-3 mx-auto transition-all group"
          >
